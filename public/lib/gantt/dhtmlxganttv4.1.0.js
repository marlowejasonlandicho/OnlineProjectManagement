    ...
    t.addEventListener ? t.addEventListener(e, n, !1) : t.attachEvent && t.attachEvent("on" + e, n)
        ...
        gantt.copy = function (t) {
            ...
            if (t && "object" == typeof t) {
                for (a = {}, n = [Array, Date, Number, String, Boolean], e = 0; e < n.length; e++)
                    t instanceof n[e] && (a = e ? new n[e](t) : new n[e]);
                for (e in t)
                    Object.prototype.hasOwnProperty.apply(t, [e]) && (a[e] = gantt.copy(t[e]))
            }
            return a || t
        },
        ...
        function () {
            function t(t) {
                ...
                if (window.getComputedStyle) {
                    ...
                    t.currentStyle && (e = t.currentStyle.display, n = t.currentStyle.visibility);
        ...
        gantt._get_position = function (t) {
            ...
            if (t.getBoundingClientRect) {
                var a = t.getBoundingClientRect(), i = document.body, s = document.documentElement, r = window.pageYOffset || s.scrollTop || i.scrollTop, o = window.pageXOffset || s.scrollLeft || i.scrollLeft, _ = s.clientTop || i.clientTop || 0, l = s.clientLeft || i.clientLeft || 0;
                return e = a.top + r - _, n = a.left + o - l, {y: Math.round(e), x: Math.round(n), width: t.offsetWidth, height: t.offsetHeight}
            }
            for (; t; )
                e += parseInt(t.offsetTop, 10), n += parseInt(t.offsetLeft, 10),
                        t = t.offsetParent;
        ...
        function () {
            gantt.mixin(gantt.config, {links: {finish_to_start: "0", start_to_start: "1", finish_to_finish: "2",
                    start_to_finish: "3"}, types: {task: "task", project: "project", milestone: "milestone"}, duration_unit: "day", work_time: !1, correct_work_time: !1, skip_off_time: !1, autosize: !1, autosize_min_width: 0, show_links: !0, show_task_cells: !0, static_background: !1, branch_loading: !1, show_loading: !1, show_chart: !0, show_grid: !0, min_duration: 36e5, xml_date: "%d-%m-%Y %H:%i", api_date: "%d-%m-%Y %H:%i", start_on_monday: !0, server_utc: !1, show_progress: !0, fit_tasks: !1, select_task: !0, scroll_on_click: !0, preserve_scroll: !0, readonly: !1, date_grid: "%Y-%m-%d",
                drag_links: !0, drag_progress: !0, drag_resize: !0, drag_move: !0, drag_mode: {resize: "resize", progress: "progress", move: "move", ignore: "ignore"}, round_dnd_dates: !0, link_wrapper_width: 20, root_id: 0, autofit: !1, columns: [{name: "text", tree: !0, width: "*", resize: !0}, {name: "start_date", align: "center", resize: !0}, {name: "duration", align: "center"}, {name: "add", width: "44"}], step: 1, scale_unit: "day", scale_offset_minimal: !0, subscales: [], inherit_scale_class: !1, time_step: 60, duration_step: 1, date_scale: "%d %M", task_date: "%d %F %Y",
                time_picker: "%H:%i", task_attribute: "task_id", link_attribute: "link_id", layer_attribute: "data-layer", buttons_left: ["gantt_save_btn", "gantt_cancel_btn"], _migrate_buttons: {dhx_save_btn: "gantt_save_btn", dhx_cancel_btn: "gantt_cancel_btn", dhx_delete_btn: "gantt_delete_btn"}, buttons_right: ["gantt_delete_btn"], lightbox: {sections: [{name: "description", height: 70, map_to: "text", type: "textarea", focus: !0}, {name: "time", type: "duration", map_to: "auto"}], project_sections: [{name: "description", height: 70, map_to: "text", type: "textarea",
                            focus: !0}, {name: "type", type: "typeselect", map_to: "type"}, {name: "time", type: "duration", readonly: !0, map_to: "auto"}], milestone_sections: [{name: "description", height: 70, map_to: "text", type: "textarea", focus: !0}, {name: "type", type: "typeselect", map_to: "type"}, {name: "time", type: "duration", single_date: !0, map_to: "auto"}]}, drag_lightbox: !0, sort: !1, details_on_create: !0, details_on_dblclick: !0, initial_scroll: !0, task_scroll_offset: 100, order_branch: !1, order_branch_free: !1, task_height: "full", min_column_width: 70, min_grid_column_width: 70,
                grid_resizer_column_attribute: "column_index", grid_resizer_attribute: "grid_resizer", keep_grid_width: !1, grid_resize: !1, show_unscheduled: !0, readonly_property: "readonly", editable_property: "editable", type_renderers: {}, open_tree_initially: !1, optimize_render: !0, prevent_default_scroll: !1, show_errors: !0, wai_aria_attributes: !0, smart_scales: !0}), gantt.keys = {edit_save: 13, edit_cancel: 27}, gantt._init_template = function (t, e, n) {
                ...
                gantt._init_template("date_scale", !0), gantt._init_template("date_grid", !0, "grid_date_format"), gantt._init_template("task_date", !0), gantt.mixin(this.templates, {xml_date: this.date.str_to_date(n.xml_date, n.server_utc), xml_format: e(n.xml_date, n.server_utc), api_date: this.date.str_to_date(n.api_date),
                    progress_text: function (t, e, n) {
                        ...
                        return""
                    }, time_picker: e(n.time_picker), link_class: function (t) {
                        return""
...
//            return;
            ...
            if (a) {
                ...
                //&& gantt.showLightbox(n) Modified/Removed by Me
//########
//Modified by Me
                var opmTask = gantt.getTask(n);
                if (opmTask && opmTask.parent > 0) {
                    angular.element($('#taskView')).scope().setScopeValues(gantt.getTask(n));
                    angular.element($('#opm_tabbar > div > ul > li:nth-child(2) a')).triggerHandler('click');
                }
//########
            }
        },
        ...
        gantt._DnD = function (t, e) {
            this._obj = t, e && (this._settings = e), gantt._eventable(this), this.initEventAccessor(), this._drag_start_timer = null, gantt.attachEvent("onGanttScroll", gantt.bind(function (t, e) {
                ...
                e.original_target = {target: n.target || n.srcElement}, gantt.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(gantt.bind(function () {
                    this.dragStart(t, n)
        ...
        gantt._DnD.prototype = {
            traceDragEvents: function (t) {
                ...
                var e = t.x - this.config.pos.x, n = t.y - this.config.pos.y, a = Math.sqrt(Math.pow(Math.abs(e), 2) + Math.pow(Math.abs(n), 2));
                ...
                if (gantt.config.touch) {
                    var e = this.eventAccessor(t), n = e.target || e.srcElement, a = n.cloneNode(!0);
                    this.config.original_target = {target: a}, this.config.backup_element = n, n.parentNode.appendChild(a), n.style.display = "none", document.body.appendChild(n)
                }
            }, initEventAccessor: function () {
                var t = this._evs = {move: "mousemove", down: "mousedown", up: "mouseup"};
                this.eventAccessor = function (t) {
                    ...
                    return t.touches && t.touches.length > 1 ? null : t.touches[0] ? {target: document.elementFromPoint(t.touches[0].clientX, t.touches[0].clientY),
                        pageX: t.touches[0].pageX, pageY: t.touches[0].pageY, clientX: t.touches[0].clientX, clientY: t.touches[0].clientY} : t
                }))
            }, clearDragTimer: function () {
                this._drag_start_timer && (clearTimeout(this._drag_start_timer), this._drag_start_timer = null)
            }, dragStart: function (t, e) {
                this.config = {obj: t, marker: null, started: !1, pos: this.getPosition(e), sensitivity: 4}, this._settings && gantt.mixin(this.config, this._settings, !0), this.traceDragEvents(t), gantt._prevent_touch_scroll = !0, document.body.className += " gantt_noselect", gantt.config.touch && this.dragMove(t, e);
                ...
                if (n) {
                    if (!this.config.marker && !this.config.started) {
                        ...
                        if (gantt.config.touch || this.checkPositionChange(a)) {
                            if (this.config.started = !0, this.config.ignore = !1, this.callEvent("onBeforeDragStart", [t, this.config.original_target]) === !1)
                ...
                var e = 0, n = 0;
                return t = t || window.event, t.pageX || t.pageY ? (e = t.pageX, n = t.pageY) : (t.clientX || t.clientY) && (e = t.clientX + document.body.scrollLeft + document.documentElement.scrollLeft, n = t.clientY + document.body.scrollTop + document.documentElement.scrollTop), {x: e, y: n}
    ...
    for (var t = this.getGridColumns(), e = [], n = 0, a = this.locale.labels, i = this.config.scale_height - 2, s = 0; s < t.length; s++) {
        ...
        var l = this._sort && o.name == this._sort.name ? "<div class='gantt_sort gantt_" + this._sort.direction + "'></div>" : "", d = ["gantt_grid_head_cell", "gantt_grid_head_" + o.name, r ? "gantt_last_cell" : "", this.templates.grid_header_class(o.name, o)].join(" "), g = "width:" + (_ - (r ? 1 : 0)) + "px;", h = o.label || a["column_" + o.name];
        h = h || "";
        var c = this._waiAria.gridScaleCellAttrString(o, h), u = "<div class='" + d + "' style='" + g + "' " + c + " column_id='" + o.name + "'>" + h + l + "</div>";
        e.push(u)
    }
    ...
    for (var e, n = this.getGridColumns(), a = [], i = 0; i < n.length; i++) {
        var s, r, o, _ = i == n.length - 1, l = n[i];
        if ("add" == l.name) {
            var d = this._waiAria.gridAddButtonAttrString(l);
            r = "<div " + d + " class='gantt_add'></div>", o = ""
        } else
            r = l.template ? l.template(t) : t[l.name], r instanceof Date && (r = this.templates.date_grid(r, t)), o = r, r = "<div class='gantt_tree_content'>" + r + "</div>";
        var g = "gantt_cell" + (_ ? " gantt_last_cell" : ""), h = "";
        if (l.tree) {
            for (var c = 0; c < t.$level; c++)
                h += this.templates.grid_indent(t);
    ...
    if (t != n) {
        ...
        var i = this.getTask(t), s = this.getParent(i.id), r = (this.getChildren(this.getParent(i.id)),
                this.getChildren(n));
    ...
    this.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", this.bind(function (e, n) {
        ...
        for (var e = gantt._order, n = gantt._pull, a = null, i = 0, s = e.length; s > i; i++)
        ...
        var e = this._get_position(this.$grid_data), n = t.pageY - e.y + gantt.getScrollState().y;
        return 0 > n && (n = 0), n
        ...
        var r = this.getTask(t.config.id), o = t._getTargetY(n), _ = t._getTaskByY(o, gantt.getGlobalTaskIndex(r.id));
        if (this.isTaskExists(_) || (_ = t.lastTaskOfLevel(gantt.config.order_branch_free ? r.$level : 0), _ == t.config.id && (_ = null)), this.isTaskExists(_)) {
            ...
            if (gantt.getGlobalTaskIndex(l.id) * this.config.row_height + this.config.row_height / 2 < o) {
                var d = this.getGlobalTaskIndex(l.id), g = this._pull[this._order[d + 1]];
                if (g) {
                    if (g.id == r.id)
                        return this.config.order_branch_free && this.isChildOf(r.id, l.id) && 1 == this.getChildren(l.id).length ? void this.moveTask(r.id, this.getTaskIndex(l.id) + 1, this.getParent(l.id)) : void 0;
                    l = g
                } else if (g = this._pull[this._order[d]], a(g, r) && g.id != r.id)
                ...
                if (!this.hasChild(l.id))
                    return void this.moveTask(r.id, -1, l.id);
                if (this.getGlobalTaskIndex(l.id))
                    return
            }
            for (var d = this.getGlobalTaskIndex(l.id), h = this._pull[this._order[d - 1]], c = 1; (!h || h.id == l.id) && d - c >= 0; )
    ...
    return this.getChildren(t).length > 0
        ...
        gantt._init_resize = function () {
            ...
            this.defined(this.config.dnd_sensitivity) && (i.config.sensitivity = this.config.dnd_sensitivity), i.attachEvent("onBeforeDragStart", this.bind(function (e, i) {
                ...
                for (var u = h > 0 ? 1 : -1; h > 0 && 1 === u || 0 > h && -1 === u; ) {
                    ...
                    for (o = 0; l > o; o++) {
                        var f = a[o].width + u;
                        if ((a[o].min_width && f >= a[o].min_width || !a[o].min_width || d > a[o].width) && (h -= u, a[o].width = f, 0 === h))
                            break
                    }
                    if (g == h)
                        break
        ...
        function () {
            ...
            var a = new RegExp("<(?:.|\n)*?>", "gm"), i = new RegExp(" +", "gm"), s = new RegExp("'", "gm");
            gantt._waiAria = {getAttributeString: function (n) {
                    var a = [" "];
                    for (var i in n) {
                        var s = e(t(n[i]));
                        a.push(i + "='" + s + "'")
                    ...
                    this._taskCommonAttr(t, e),
                            !gantt._is_readonly(t) && gantt.config.order_branch && e.setAttribute("aria-grabbed", !1), e.setAttribute("role", "row"), e.setAttribute("aria-level", t.$level), gantt._has_children(t.id) && e.setAttribute("aria-expanded", t.$open ? "true" : "false")
                }, linkAttr: function (e, n) {
                    var a = gantt.config.links, i = e.type == a.finish_to_start || e.type == a.start_to_start, s = e.type == a.start_to_start || e.type == a.start_to_finish, r = gantt.locale.labels.link + " " + gantt.templates.drag_link(e.source, s, e.target, i);
                    ...
                    return this.getAttributeString({role: "button", "aria-label": gantt.locale.labels[t],
                        tabindex: "0"})
                    ...
                    return this.getAttributeString({"aria-label": gantt.locale.labels.column_duration,
                        "aria-valuemin": "0"})
                    ...
                    var n = "";
                    if ("add" == t.name)
                        n = this.getAttributeString({role: "button", "aria-label": gantt.locale.labels.new_task});
                    else {
                    ...
                    return gantt._waiAria.getAttributeString({role: "button", "aria-label": t, tabindex: "0"})
        ...
        gantt._scale_helpers = {getSum: function (t, e, n) {
                void 0 === n && (n = t.length - 1), void 0 === e && (e = 0);
                for (var a = 0, i = e; n >= i; i++)
                    a += t[i];
                return a
                ...
                if (this.config.skip_off_time) {
                    for (var n = !0, a = t, i = 0; i < e.step; i++)
                        i && (a = gantt.date.add(t, i, e.unit)), n = n && !this.isWorkTime(a, e.unit);
                    return n
                }
                return!1
                ...
                var e = gantt.mixin({count: 0, col_width: 0, full_width: 0, height: 0,
                    width: [], left: [], trace_x: [], trace_indexes: {}}, t);
            ...
            }}, gantt._tasks_dnd = {drag: null, _events: {before_start: {},
        before_finish: {}, after_finish: {}}, _handlers: {}, init: function () {
        this.clear_drag_state();
        var t = gantt.config.drag_mode;
        this.set_actions();
        var e = {before_start: "onBeforeTaskDrag", before_finish: "onBeforeTaskChanged", after_finish: "onAfterTaskDrag"};
        for (var n in this._events)
            for (var a in t)
                this._events[n][a] = e[n];
            ...
            if (gantt.isTaskExists(n) && (a = gantt.getTask(n)), !gantt._is_readonly(a) && !this.drag.mode) {
                ...
                if (s)
                    if (s.mode && s.mode != gantt.config.drag_mode.ignore && gantt.config["drag_" + s.mode]) {
                        if (n = gantt.locate(e), a = gantt.copy(gantt.getTask(n) || {}), gantt._is_readonly(a))
                            return this.clear_drag_state(), !1;
                        if (gantt._is_flex_task(a) && s.mode != gantt.config.drag_mode.progress)
                        ...
                        this.clear_drag_state();
                else if (gantt.checkEvent("onMouseDown") && gantt.callEvent("onMouseDown", [i.split(" ")[0]]) && e.parentNode)
        ...
        gantt.config.round_dnd_dates || (i = "minute", s = gantt.config.time_step), e.mode == gantt.config.drag_mode.resize ? e.left ? (t.start_date = gantt.roundDate({date: t.start_date, unit: i, step: s}), n(t)) : (t.end_date = gantt.roundDate({
            date: t.end_date, unit: i, step: s}), a(t)) : e.mode == gantt.config.drag_mode.move && (t.start_date = gantt.roundDate({date: t.start_date, unit: i, step: s}), n(t), t.end_date = gantt.calculateEndDate(t.start_date, t.duration, gantt.config.duration_unit))
    }, _fix_working_times: function (t, e) {
        var e = e || {mode: gantt.config.drag_mode.move};
        gantt.config.work_time && gantt.config.correct_work_time && (e.mode == gantt.config.drag_mode.resize ? e.left ? t.start_date = gantt.getClosestWorkTime({date: t.start_date, dir: "future"}) : t.end_date = gantt.getClosestWorkTime({
            date: t.end_date, dir: "past"}) : e.mode == gantt.config.drag_mode.move && gantt.correctTaskWorkTime(t))
        ...
        if (e.mode && e.id) {
            ...
            if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e), this._fix_dnd_scale_time(n, e), gantt._init_task_timing(n), this._fireEvent("before_finish", e.mode, [e.id, e.mode, gantt.copy(e.obj), t])) {
                ...
                e.obj._dhx_changed = !1, gantt.mixin(n, e.obj, !0), gantt.updateTask(n.id)
        }
        this.clear_drag_state()
    ...
    for (var e = this.getLink(t), n = gantt._get_link_renderers(), a = 0; a < n.length; a++)
        n[a].render_item(e)
    ...
    var i = null;
    if (i = "object" == typeof t ? t : {source: t, target: e, type: this._get_link_type(n, a)}, !i)
        return!1;
    if (!(i.source && i.target && i.type))
        return!1;
    ...
    var l = a[a.length - 1].direction, d = gantt._render_link_arrow(e[e.length - 1], l);
    ...
    return n.style.cssText = ["top:" + i + "px", "left:" + s + "px"].join(";"), n.className = _,
        ...
        var e, n = gantt.config.link_wrapper_width, a = (gantt.config.link_line_width, t.y + (gantt.config.row_height - n) / 2);
        switch (t.direction) {
            case this.dirs.left:
    ...
    return t * gantt.config.row_height
        ...
        if (t.type == gantt.config.links.start_to_start)
            this.point_to(s.left, r), o ? (this.point_to(s.down, a), this.point_to(s.right, i)) : (this.point_to(s.right, i), this.point_to(s.down, a)), this.point_to(s.right, r);
            ...
            this.point_to(s.right, r), o ? (this.point_to(s.right, i), this.point_to(s.down, a)) : (this.point_to(s.down, a), this.point_to(s.right, i)), this.point_to(s.left, r);
    ...
    function s(t, e, n, i) {
        var s = _(), l = a(), d = ["gantt_link_direction"];
    ...
    var d = new gantt._DnD(this.$task_bars, {sensitivity: 0, updates_per_second: 60}), g = "task_left", h = "task_right", c = "gantt_link_point", u = "gantt_link_control";
    d.attachEvent("onBeforeDragStart", gantt.bind(function (e, n) {
        var a = n.target || n.srcElement;
        if (i(), gantt.getState().drag_id)
            return!1;
        ...
        var r = d.config, o = d.getPosition(i);
        n(r.marker, o);
        var _ = gantt._is_link_drop_area(i), l = gantt._link_target_task, g = gantt._link_landing, c = gantt._link_target_task_start, f = gantt.locate(i), p = !0;
        if (_ && (p = !gantt._locate_css(i, h), _ = !!f), gantt._link_target_task = f, gantt._link_landing = _, gantt._link_target_task_start = p, _) {
            ...
            this._dir_end = gantt._get_mouse_pos(i);
        var b = !(g == _ && l == f && c == p);
    ...
    return this._task_area_pulls || (this._task_area_pulls = {}),
            this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || this.assert(!1, "Invalid renderer call"), n && n.setAttribute(this.config.layer_attribute, !0), this._task_area_renderers[t] = {render_item: function (t, i) {
            if (i = i || n, a && !a(t))
                return void this.remove_item(t.id);
    ...
    this._tasks = {col_width: this.config.columnWidth, width: [], full_width: 0, trace_x: [], rendered: {}}, this._click.gantt_task_link = this.bind(function (t, e) {
    ...
    this._dbl_click.gantt_task_link = this.bind(function (t, e, n) {
        var e = this.locate(t, gantt.config.link_attribute);
        this._delete_link_handler(e, t)
    }, this), 
    this._dbl_click.gantt_link_point = this.bind(function (t, e, n) {
    ...
    var e = this.addLinkLayer({renderer: this._render_link_element, container: this.$task_links, filter: gantt._create_filter([gantt._filter_link, gantt._is_chart_visible].concat(this._get_link_filters()))});
    this._linkRenderer = this._link_layers.getRenderer(e),
            this._task_layers.clear();
    var n = this.addTaskLayer({renderer: this._render_task_element, container: this.$task_bars, filter: gantt._create_filter([gantt._filter_task, gantt._is_chart_visible].concat(this._get_task_filters()))});
    this._taskRenderer = this._task_layers.getRenderer(n), this.addTaskLayer({renderer: this._render_grid_item, container: this.$grid_data, filter: gantt._create_filter([gantt._filter_task, gantt._is_grid_visible].concat(this._get_task_filters()))}), this.addTaskLayer({renderer: this._render_bg_line,
        container: this.$task_bg, filter: gantt._create_filter([gantt._filter_task, gantt._is_chart_visible, gantt._is_std_background].concat(this._get_task_filters()))}), this._onTaskIdChange && this.detachEvent(this._onTaskIdChange), this._onTaskIdChange = this.attachEvent("onTaskIdChange", function (e, n) {
    ...
    for (var l = o; _ > l && t.trace_x[l]; l++) {
        ...
        var d = s.call(this, i), g = t.width[l], h = t.height - (this.config.smart_scales && t.index ? 1 : 0), c = t.left[l], u = "", f = "", p = "";
        if (g) {
            ...
            var m = gantt._waiAria.getTimelineCellAttr(d), k = "<div class='" + p + "'" + m + " style='" + u + "'>" + d + "</div>";
            a.push(k)
        }
    }
    return a.join("")
    ...
    for (var a = [], i = this.templates.scale_row_class, s = 0; s < t.length; s++) {
        var r = "gantt_scale_line", o = i(t[s]);
        o && (r += " " + o),
    ...
    if (this.config.smart_scales) {
        var t = this._scales, e = gantt.getScrollState().x;
    ...
    if (this._is_chart_visible()) {
        ...
        var r = this._get_resize_options(), o = r.x ? Math.max(this.config.autosize_min_width, 0) : Math.max(this._x - this._get_grid_width() - 2, 0), _ = i.prepareConfigs(s, this.config.min_column_width, o, a), l = this._tasks = _[_.length - 1];
        this._scales = _,
    ...
    var _ = t.$index % 2 !== 0, l = gantt.templates.task_row_class(t.start_date, t.end_date, t), d = "gantt_task_row" + (_ ? " odd" : "") + (l ? " " + l : "");
    ...
    if (this.config.fit_tasks) {
        ...
        if (this._init_tasks_range(), +this._min_date != t || +this._max_date != e)
    ...
    if (a && this.isTaskVisible(t)) {
        ...
        if (void 0 !== e && !e)
            return;
        for (var i = 0; i < a.$source.length; i++)
            gantt.refreshLink(a.$source[i]);
        for (var i = 0; i < a.$target.length; i++)
            gantt.refreshLink(a.$target[i])
    }
    ...
    if (r.link_source_id == n && a.push("gantt_link_source"), r.link_target_id == n && a.push("gantt_link_target"), this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && a.push("gantt_critical_task"),
        ...
        var o = r.link_source_id, _ = r.link_source_start, l = r.link_target_start, d = gantt.isLinkAllowed(o, n, _, l), g = "";
    ...
    return t ? {$source: [gantt.config.links.start_to_start], $target: [gantt.config.links.start_to_start, gantt.config.links.finish_to_start]} : {$source: [gantt.config.links.finish_to_start, gantt.config.links.finish_to_finish], $target: [gantt.config.links.finish_to_finish]}
    ...
    var e = {second: 1, minute: 60, hour: 3600, day: 86400, week: 604800, month: 2592e3, quarter: 7776e3, year: 31536e3};
    return e[t] || e.hour
    ...
    var n = gantt.env.isIE ? document.documentElement : document.body, e = {x: t.clientX + n.scrollLeft - n.clientLeft, y: t.clientY + n.scrollTop - n.clientTop}, a = gantt._get_position(gantt.$task_data);
...
}), gantt._layers = {prepareConfig: function (t) {
        "function" == typeof t && (t = {renderer: t});
        t.id = gantt.uid();
        return t.container || (t.container = document.createElement("div")), t
    }, create: function (t, e) {
        return{tempCollection: [], renderers: {}, container: t, getRenderers: function () {
                var t = [];
    ...
    this._order = [], this._order_full = [], this._order_search = {}, this._sync_order_item({parent: this.config.root_id, $open: !0, $ignore: !0, id: this.config.root_id}), t || (this._scroll_resize(), this._set_sizes())
    ...
    for (var a = e; this.getParent(a) && this.isTaskExists(this.getParent(a)); )
        ...
        var e = {};
        for (var n in t)
            "$" != n.charAt(0) && (e[n] = t[n], e[n]instanceof Date && (e[n] = gantt.templates.xml_format(e[n])));
        return e
    }, serialize: function () {
        var t = [], e = [];
    ...
    }}, gantt.xml = {_xmlNodeToJSON: function (t, e) {
        ...
        for (var e = {}, n = gantt.ajax.xpath("//coll_options", t), a = 0; a < n.length; a++)
            for (var i = n[a].getAttribute("for"), s = e[i] = [], r = gantt.ajax.xpath(".//item", n[a]), o = 0; o < r.length; o++) {
                for (var _ = r[o], l = _.attributes, d = {key: r[o].getAttribute("value"), label: r[o].getAttribute("label")}, g = 0; g < l.length; g++) {
                    var h = l[g];
        ...
        e = this._getXML(t, e);
        for (var n = {}, a = n.data = [], i = gantt.ajax.xpath("//task", e), s = 0; s < i.length; s++)
        ...
        for (var t = [], e = [], n = gantt.json.serialize(), a = 0, i = n.data.length; i > a; a++)
    ...
    }}, gantt.oldxml = {parse: function (t, e) {
        ...
        for (var s = 0; s < a.length; s++) {
            var o = a[s];
            o.start_date = o.startdate || o.est, o.end_date = o.enddate, o.text = o.name, o.duration = o.duration / 8, o.open = 1, o.duration || o.end_date || (o.duration = 1), o.predecessortasks && n.collections.links.push({target: o.id, source: o.predecessortasks, type: gantt.config.links.finish_to_start})
        }
        return n
    }, serialize: function () {
...
}, gantt._working_time_helper = {units: ["year", "month", "week", "day", "hour", "minute"], default_calendar: function () {
        return{hours: [0, 17], dates: {0: !1, 6: !1}}
    }, _working_units_cache: {_cache: {}, get: function (t, e) {
    ...
    _check_is_working_unit: function (t, e, n) {
        ...
        for (var i = new Date(t), s = new Date(e), a = a || 1, r = 0; i.valueOf() < s.valueOf(); )
        ...
        for (var n = 0, a = new Date(t), i = new Date(e); a.valueOf() < i.valueOf(); )
            this.is_working_unit(a, "day") && (n += this.get_hours_per_day(a)), a = this.next_date(a, "day", 1);
        return n
    }, get_work_units_between_hours: function (t, e, n, a) {
        var i = new Date(t), s = new Date(e), a = a || 1, r = new Date(i), o = gantt.date.add(gantt.date.day_start(new Date(i)), 1, "day");
        if (s.valueOf() <= o.valueOf())
            return this.get_work_units_between_generic(t, e, n, a);
        var _ = gantt.date.day_start(new Date(s)), l = s, d = this.get_work_units_between_generic(r, o, n, a), g = this.get_work_units_between_generic(_, l, n, a), h = this.get_work_hours_for_range(o, _);
        ...
        if (this.is_working_unit(t.date, t.unit))
            return t.date;
        var e = t.unit, n = gantt.date[e + "_start"](t.date), a = new Date(n), i = new Date(n), s = !0, r = 3e3, o = 0, _ = "any" == t.dir || !t.dir, l = 1;
        for ("past" == t.dir && (l = -1); !this.is_working_unit(n, e); ) {
            _ && (n = s ? a : i, l = -1 * l);
            var d = n.getTimezoneOffset();
            if (n = gantt.date.add(n, l, e), n = gantt._correct_dst_change(n, d, l, e), gantt.date[e + "_start"] && (n = gantt.date[e + "_start"](n)), _ && (s ? a = n : i = n), s = !s, o++, o > r)
    ...
    if (!e)
        return[];
    for (var n = e.$source.concat(e.$target), a = this.getChildren(e.id), i = 0; i < a.length; i++)
    ...
    for (var s = 0; s < t.length; s++)
        n && (this._dp.setGanttMode("links"), this._dp.setUpdated(t[s], !0, "deleted")), this._deleteLink(t[s], !0);
    ...
    gantt.config.work_time && gantt.config.correct_work_time && (gantt.isWorkTime(t.start_date) ? gantt.isWorkTime(new Date(+t.end_date - 1)) || (t.end_date = gantt.calculateEndDate(t.start_date, t.duration)) : (t.start_date = gantt.getClosestWorkTime({
        date: t.start_date, dir: "future"}), t.end_date = gantt.calculateEndDate(t.start_date, t.duration)))
    ...
    if (r == gantt._tasks.unit && s == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date)
        a = Math.floor(gantt._day_index_by_date(i)), gantt._tasks.trace_x[a] || (a -= 1), n = new Date(gantt._tasks.trace_x[a]), e = new Date(n), e = gantt._tasks.trace_x[a + 1] ? new Date(gantt._tasks.trace_x[a + 1]) : gantt.date.add(n, s, r);
    else {
    ...
    function e(e) {
        for (var n = t.updatedRows.slice(), a = !1, i = 0; i < n.length && !t._in_progress[e]; i++)
            n[i] == e && ("inserted" == gantt.getUserData(e, "!nativeeditor_status") && (a = !0),
                    t.setUpdated(e, !1));
        return a
    }
    t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {updated: "gantt_updated", order: "gantt_updated", inserted: "gantt_inserted", deleted: "gantt_deleted", invalid: "gantt_invalid", error: "gantt_error", clear: ""}, t._methods = ["_row_style", "setCellTextStyle", "_change_id", "_delete_task"], t.setGanttMode = function (e) {
        var n = t.modes || {};
        t._ganttMode && (n[t._ganttMode] = {_in_progress: t._in_progress,
            _invalid: t._invalid, updatedRows: t.updatedRows});
        var a = n[e];
        a || (a = n[e] = {_in_progress: {}, _invalid: {}, updatedRows: []}), t._in_progress = a._in_progress, t._invalid = a._invalid, t.updatedRows = a.updatedRows, t.modes = n, t._ganttMode = e
    ...
    this.attachEvent("onTaskIdChange", function (e, i) {
        if (t._waitMode) {
            ...
            var _ = this.getTask(i), l = this._get_task_links(_);
            if (l.length) {
                a = a || {};
        ...
        (n || a) && (gantt.batchUpdate(function () {
            for (var t in n)
                gantt.updateTask(n[t].id);
            for (var t in a)
                gantt.updateLink(a[t].id);
            n = null, a = null
        ...
        if ("REST" == this._tMode) {
            ...
            this.serverProcessor = t + gantt._urlSeparator(t) + "gantt_mode=" + this._ganttMode;
        return!0
    ...
    t.afterUpdate = function () {
        ...
        var n = t._ganttMode, a = e.filePath;
    ...
    var n = null, a = e ? t.target : t.source;
    ...
    return e || this.callEvent("onBeforeLinkDelete", [t, n]) !== !1 ? (delete this._lpull[t], this._sync_links(), this.refreshLink(t), e || this.callEvent("onAfterLinkDelete", [t, n]),
            !0) : !1
    ...
    for (var a in e)
        ("undefined" == typeof t[a] || n) && (t[a] = e[a])
...
gantt._get_timepicker_step = function () {
    ...
    if (void 0 === t && (t = this.getLightboxType()),
        ...
        for (var r = 0; r < _.length; r++) {
            ...
            if (g.id && document.getElementById(g.id)) {
                var h = document.getElementById(g.id), c = h.querySelector("label"), u = h.nextSibling;
                if (u) {
    ...
    gantt.lightbox_events = {}, gantt.lightbox_events.gantt_save_btn = function (t) {
        ...
        var e = t || window.event, n = t.target || t.srcElement, a = !!(gantt._getClassName(n).indexOf("gantt_btn_set") > -1);
        switch ((t || e).keyCode) {
            case 32:
                if ((t || e).shiftKey)
                    return;
    ...
    return n[t.type] && ("auto" == t.map_to ? e = {start_date: "start_date", end_date: "end_date",
        duration: "duration"} : "string" == typeof t.map_to && (e = {start_date: t.map_to})), e
    ...
    var n = t, a = e.getElementsByTagName("span"), i = [];
    ...
    for (var s = this._get_typed_lightbox_config(this.getLightboxType()), r = 0; r < s.length; r++) {
        ...
        if (this.form_blocks[o.type]) {
            var _ = document.getElementById(o.id).nextSibling, l = this.form_blocks[o.type], d = gantt._resolve_default_mapping(s[r]), g = this.defined(n[d]) ? n[d] : o.default_value;
    ...
    var i = document.getElementById(a.id), s = i.nextSibling, r = {section: a, header: i, node: s, getValue: function (t) {
    ...
    getTimePicker: function (t, e) {
        ...
        for (var o = "", _ = 0; _ < n.length; _++) {
            ...
            switch (l) {
                ...
                case"%m":
                    ...
                    for (var f = 0; 12 > f; f++)
                        d += "<option value='" + f + "'>" + this.locale.date.month_full[f] + "</option>";
                    break;
                case"%d":
            ...
            if (d) {
                var k = gantt._waiAria.lightboxSelectAttrString(l), b = t.readonly ? "disabled='disabled'" : "", y = e ? " style='display:none' " : "";
        ...
        if (t[e + a[0]].value = n.getDate(), t[e + a[1]].value = n.getMonth(), t[e + a[2]].value = n.getFullYear(), gantt.defined(a[3])) {
            ...
            return t.innerHTML || ""
        }, focus: function (t) {}}, textarea: {render: function (t) {
            ...
            for (var e = (t.height || "23") + "px", n = "<div class='gantt_cal_ltext' style='height:" + e + ";'><select style='width:100%;'>", a = 0; a < t.options.length; a++)
                n += "<option value='" + t.options[a].key + "'>" + t.options[a].label + "</option>";
            return n += "</select></div>"
        }, set_value: function (t, e, n, a) {
            var i = t.firstChild;
            ...
            var d = n[l.start_date] || new Date, g = n[l.end_date] || gantt.calculateEndDate(d, 1);
            ...
            var d = gantt._resolve_default_mapping(n), g = {start_date: new Date(_), end_date: new Date(l)};
            return"string" == typeof d ? g.start_date : g
        }, focus: function (t) {
            gantt._focus(t.getElementsByTagName("select")[0])
        }}, duration: {render: function (t) {
            ...
            var r = a, o = t.getElementsByTagName("select"), _ = t.getElementsByTagName("input"), l = _[1], d = [_[0], _[2]], g = t.getElementsByTagName("span")[0], h = a._time_format_order;
            ...
            var a = gantt.form_blocks.duration._get_start_date(t, n), i = gantt.form_blocks.duration._get_duration(t, n), s = gantt.calculateEndDate(a, i), r = gantt._resolve_default_mapping(n), o = {start_date: new Date(a), end_date: new Date(s), duration: i};
            return"string" == typeof r ? o.start_date : o
        }, focus: function (t) {
            gantt._focus(t.getElementsByTagName("select")[0]);
        }}, parent: {_filter: function (t, e, n) {
            ...
            var n = [], a = [];
            e && (n = gantt.getTaskByTime(), t.allow_root && n.unshift({id: gantt.config.root_id, text: t.root_label || ""}), n = this._filter(n, t, e), t.sort && n.sort(t.sort));
    ...
    if (this.getState().lightbox) {
        ...
        this.resetLightbox(), this.getLightbox(t ? t : void 0);
    this.callEvent("onLightboxChange", [e, this.getLightboxType()])
}, gantt._extend_to_optional = function (t) {
    var e = t, n = {render: e.render, focus: e.focus, set_value: function (t, a, i, s) {
    ...
    return this.serverProcessor = t, this.action_param = "!nativeeditor_status", this.object = null, this.updatedRows = [],
            this.autoUpdate = !0, this.updateMode = "cell", this._tMode = "GET", this._headers = null, this._payload = null, this.post_delim = "_", this._waitMode = 0, this._in_progress = {}, this._invalid = {}, this.mandatoryFields = [], this.messages = [], this.styles = {updated: "font-weight:bold;", inserted: "font-weight:bold;", deleted: "text-decoration : line-through;", invalid: "background-color:FFE0E0;", invalid_cell: "border-bottom:2px solid red;", error: "color:red;", clear: "font-weight:normal;text-decoration:none;"}, this.enableUTFencoding(!0),
            gantt._eventable(this), this
}, gantt.dataProcessor.prototype = {setTransactionMode: function (t, e) {
    ...
    }, _clearUpdateFlag: function (t) {}, markRow: function (t, e, n) {
        ...
        var n = [], a = [];
        for (var i in t)
            t.hasOwnProperty(i) && (n.push(this.serialize_one(t[i], i + this.post_delim)),
                    a.push(i));
        ...
        if (t) {
            ...
            if ("GET" == this._tMode)
                gantt.ajax.get(i + (-1 != i.indexOf("?") ? "&" : "?") + this.serialize(t, e), a);
                ...
                if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (_ = "DELETE", r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (_ = "PUT", o = this.serialize(t, e), r = r + ("/" == r.slice(-1) ? "" : "/") + e), this._payload)
                    for (var l in this._payload)
                        r = r + this._urlSeparator(r) + this.escape(l) + "=" + this.escape(this._payload[l]);
        ...
        if (s || this.set_invalid(t, n), this._uActions && this._uActions[n] && !this._uActions[n](a))
        ...
        if (window.JSON) {
            ...
            if (a) {
                var s = a.action || this.getState(n) || "updated", r = a.sid || n[0], o = a.tid || n[0];
        ...
        for (var d = 0; d < l.length; d++) {
            var g = l[d], s = g.getAttribute("type"), r = g.getAttribute("sid"), o = g.getAttribute("tid");
    ...
    }, enableDebug: function (t) {}, setOnBeforeUpdateHandler: function (t) {
    ...
    var i = t.data || gantt.xml._xmlNodeToJSON(t.firstChild), s = {
        add: gantt.addTask, isExist: gantt.isTaskExists};
    ...
    t || gantt.config.show_errors && gantt.callEvent("onError", [e]) !== !1 && gantt.message({type: "error",
        text: e, expire: -1})
    ...
    var e = this._waiAria.gridAttrString(), n = this._waiAria.gridDataAttrString(), a = "<div class='gantt_container'><div class='gantt_grid' " + e + "></div><div class='gantt_task'></div>";
    ...
    this.$grid = i[0], this.$task = i[1], this.$scroll_ver = i[2], this.$scroll_hor = i[3], this.$grid.innerHTML = "<div class='gantt_grid_scale' " + gantt._waiAria.gridScaleRowAttrString() + "></div><div class='gantt_grid_data' " + n + "></div>", this.$grid_scale = this.$grid.childNodes[0], this.$grid_data = this.$grid.childNodes[1], this.$task.innerHTML = "<div class='gantt_task_scale'></div><div class='gantt_data_area'><div class='gantt_task_bg'></div><div class='gantt_links_area'></div><div class='gantt_bars_area'></div></div>",
...
}, gantt.$click = {buttons: {edit: function (t) {
            ...
            gantt._dhtmlx_confirm(e, n, function () {
                if (!gantt.isTaskExists(t))
                    return void gantt.hideLightbox();
    ...
    var t = null;
    t = window.getComputedStyle ? window.getComputedStyle(this._obj, null) : {width: this._obj.clientWidth, height: this._obj.clientHeight};
    var e = ["width", "height", "paddingTop", "paddingBottom", "paddingLeft", "paddingRight", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], n = {
    ...
    var i = {horPaddings: n.paddingLeft + n.paddingRight + n.borderLeftWidth + n.borderRightWidth, vertPaddings: n.paddingTop + n.paddingBottom + n.borderTopWidth + n.borderBottomWidth, borderBox: n.boxSizing, innerWidth: n.width, innerHeight: n.height, outerWidth: n.width, outerHeight: n.height};
    ...
    var e, n = this._get_task_pos(this.getTask(t)), a = Math.max(n.x - this.config.task_scroll_offset, 0), i = this._scroll_sizes().y;
    ...
    function t(t) {
        ...
        if (a && Math.abs(a) > Math.abs(i)) {
            ...
            if (gantt.scrollTo(o, null), gantt.$scroll_hor.scrollLeft = o, r == gantt.$task.scrollLeft)
                return!0
        } else {
            if (n.y)
                return!0;
            ...
            var _ = gantt.$scroll_ver.scrollTop, l = gantt.$scroll_ver.scrollTop + 30 * s;
            if (!gantt.config.prevent_default_scroll && gantt._cached_scroll_pos && (gantt._cached_scroll_pos.y == l || gantt._cached_scroll_pos.y <= 0 && 0 >= l))
                return!0;
            if (gantt.scrollTo(null, l),
                    gantt.$scroll_ver.scrollTop = l, _ == gantt.$scroll_ver.scrollTop)
                return!0
        }
    ...
    return{drag_id: this._tasks_dnd.drag ? this._tasks_dnd.drag.id : void 0, drag_mode: this._tasks_dnd.drag ? this._tasks_dnd.drag.mode : void 0, drag_from_start: this._tasks_dnd.drag ? this._tasks_dnd.drag.left : void 0,
        selected_task: this._selected_task, min_date: this._min_date ? new Date(this._min_date) : void 0, max_date: this._max_date ? new Date(this._max_date) : void 0, lightbox: this._lightbox_id, touch_drag: this._touch_drag, scale_unit: this._tasks ? this._tasks.unit : void 0, scale_step: this._tasks ? this._tasks.step : void 0}
    ...
    gantt._disableMethod = function (e, n) {
        ...
        for (var e in t)
            this._disableMethod(e, t[e])
    }, gantt._restoreMethods = function () {
        for (var e in t)
            this._restoreMethod(e)
    }
    ...
    if (!this._is_render_active())
        return void this._batchUpdatePayload(t);
    var n, a = this._dp && "off" != this._dp.updateMode;
    a && (n = this._dp.updateMode, this._dp.setUpdateMode("off"));
    var i = {}, s = {_sync_order: !0, _sync_links: !0, _adjust_scales: !0, render: !0, _render_data: !0, refreshTask: !0,
        refreshLink: !0, resetProjectDates: function (t) {
            i[t.id] = t
        }};
    ...
    isFF: navigator.userAgent.indexOf("Firefox") >= 0, isIPad: navigator.userAgent.search(/iPad/gi) >= 0, isEdge: -1 != navigator.userAgent.indexOf("Edge")}, gantt.ajax = {cache: !0, method: "get", parse: function (t) {
        if ("string" != typeof t)
            return t;
        var e;
        ...
        if (a && (o.onreadystatechange = function () {
            if (4 == o.readyState || _ && 3 == o.readyState) {
                if ((200 != o.status || "" === o.responseText) && !gantt.callEvent("onAjaxError", [o]))
                    return;
                window.setTimeout(function () {
                    "function" == typeof i && i.apply(window, [{xmlDoc: o, filePath: e}]), s && ("undefined" != typeof s.postData ? gantt.ajax.postLong(s.url, s.postData, i) : gantt.ajax.getLong(s.url, i)), i = null, o = null
                }, 1)
            }
        ...
        return o.setRequestHeader("X-Requested-With", "XMLHttpRequest"), o.send(n), a ? void 0 : {xmlDoc: o, filePath: e}
    ...
    function e(e) {
        if (c) {
            e = e || event;
            var n = e.which || event.keyCode, a = !1;
    ...
    function a(t, e) {
        var n = gantt._waiAria.messageButtonAttrString(t), a = "gantt_" + t.toLowerCase().replace(/ /g, "_") + "_button dhtmlx_" + t.toLowerCase().replace(/ /g, "_") + "_button";
    ...
    function r(e, n, i) {
        var r = document.createElement("DIV"), o = gantt.uid();
    ...
    function o(t, a, i) {
        ...
        var o = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - s.offsetWidth) / 2)), _ = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - s.offsetHeight) / 2));
    ...
    function g(t, e, n) {
        return"object" != typeof t && ("function" == typeof e && (n = e, e = ""), t = {text: t, type: e, callback: n}), t
    }
    function h(t, e, n, a) {
        return"object" != typeof t && (t = {text: t, type: e, expire: n, id: a}), t.id = t.id || u.uid(), t.expire = t.expire || u.expire,
                t
    }
    var c = null;
    ...
    u.seed = (new Date).valueOf(), u.uid = function () {
        ...
        for (var n = "var temp=date.match(/[a-zA-Z]+|[0-9]+/g);", a = t.match(/%[a-zA-Z]/g), i = 0; i < a.length; i++)
            switch (a[i]) {
                case"%j":
                case"%d":
                    n += "set[2]=temp[" + i + "]||1;";
...
}(jQuery), gantt.locale = {date: {month_full: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], month_short: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    ...
    var s, r = 0, o = !1, _ = !1, l = null, d = null, g = null;
    this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1, gantt.event(gantt.$container, t[0], function (t) {
        if (!n(t) && o) {
            ...
            if (gantt._tasks_dnd.drag.id || gantt._tasks_dnd.drag.start_drag)
                return gantt._tasks_dnd.on_mouse_move(i), t.preventDefault && t.preventDefault(),
                        t.cancelBubble = !0, !1;
            if (!gantt._prevent_touch_scroll) {
                if (i && l) {
                    var g = l.pageX - i.pageX, h = l.pageY - i.pageY;
